...
const { proficientFunction, staffFunction, contentFunction, banFunction, applicationFunction } = require('./main/functions/discordBots')
const { webProf, webStaff, webContent, webBan, webApplicationCheck } = require('./main/functions/websites')
